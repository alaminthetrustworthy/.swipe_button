...
public class Swipe_button extends RelativeLayout {
    ...
    public Swipe_button(Context context) {
        super(context);

        init(context, null, -1, -1);
    }

    public Swipe_button(Context context, AttributeSet attrs) {
        super(context, attrs);

        init(context, attrs, -1, -1);
    }

    public Swipe_button(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final ImageView swipeButton;
        swipeButton = new ImageView(context);
        this.swipeButtonInner = swipeButton;

        if (attrs != null && defStyleAttr == -1 && defStyleRes == -1) {
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.Swipe_button,
                    defStyleAttr, defStyleRes);

            collapsedWidth = (int) typedArray.getDimension(R.styleable.Swipe_button_button_image_width,
                    ViewGroup.LayoutParams.WRAP_CONTENT);
            collapsedHeight = (int) typedArray.getDimension(R.styleable.Swipe_button_button_image_height,
                    ViewGroup.LayoutParams.WRAP_CONTENT);
            trailEnabled = typedArray.getBoolean(R.styleable.Swipe_button_button_trail_enabled,
                    false);
            Drawable trailingDrawable = typedArray.getDrawable(R.styleable.Swipe_button_button_trail_drawable);

            Drawable backgroundDrawable = typedArray.getDrawable(R.styleable.Swipe_button_inner_text_background);

            if (backgroundDrawable != null) {
                background.setBackground(backgroundDrawable);
            } else {
                background.setBackground(ContextCompat.getDrawable(context, R.drawable.shape_background));
            }
            ...
            if (trailEnabled) {
                ...
                if (trailingDrawable != null) {
                    ...
                    layer.setBackground(typedArray.getDrawable(R.styleable.Swipe_button_button_background));
                }
            ...
            centerText.setText(typedArray.getText(R.styleable.Swipe_button_inner_text));
            centerText.setTextColor(typedArray.getColor(R.styleable.Swipe_button_inner_text_color,
                    Color.WHITE));

            float textSize = DimentionUtils.convertPixelsToSp(
                    typedArray.getDimension(R.styleable.Swipe_button_inner_text_size, 0), context);
            ...
            disabledDrawable = typedArray.getDrawable(R.styleable.Swipe_button_button_image_disabled);
            enabledDrawable = typedArray.getDrawable(R.styleable.Swipe_button_button_image_enabled);
            float innerTextLeftPadding = typedArray.getDimension(
                    R.styleable.Swipe_button_inner_text_left_padding, 0);
            float innerTextTopPadding = typedArray.getDimension(
                    R.styleable.Swipe_button_inner_text_top_padding, 0);
            float innerTextRightPadding = typedArray.getDimension(
                    R.styleable.Swipe_button_inner_text_right_padding, 0);
            float innerTextBottomPadding = typedArray.getDimension(
                    R.styleable.Swipe_button_inner_text_bottom_padding, 0);

            int initialState = typedArray.getInt(R.styleable.Swipe_button_initial_state, DISABLED);
            ...
            Drawable buttonBackground = typedArray.getDrawable(R.styleable.Swipe_button_button_background);
            ...
            buttonLeftPadding = typedArray.getDimension(R.styleable.Swipe_button_button_left_padding, 0);
            buttonTopPadding = typedArray.getDimension(R.styleable.Swipe_button_button_top_padding, 0);
            buttonRightPadding = typedArray.getDimension(R.styleable.Swipe_button_button_right_padding, 0);
            buttonBottomPadding = typedArray.getDimension(R.styleable.Swipe_button_button_bottom_padding, 0);
            ...
            hasActivationState = typedArray.getBoolean(R.styleable.Swipe_button_has_activate_state, true);
